package client
// * THANKS TO THE AUTHORS OF BTCSUITE - SPECIFIC INSPIRATION FOR THIS FILE FROM btcd/rpcclient/backend_version.go
...
var _ NodeVersion = BitcoindVersion(0)
...
// Compile-time checks to ensure that BtcdVersion satisfy the NodeVersion
// interface.
var _ NodeVersion = BtcdVersion(0)
